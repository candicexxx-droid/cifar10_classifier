#This file shows how to retrieve and check accuracy of the trained model 
...
#Be sure to change the following two directories
checkpt_path = "training_1/cp-{epoch:04d}.ckpt"
test_data_dir = "/content/drive/MyDrive/VCLA-research/cifar10_np_data/"
